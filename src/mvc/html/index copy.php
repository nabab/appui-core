...
(async () => {
  ...
  if (!hasServiceWorker) {
    document.getElementById('loading_message').innerHTML = <?= Str::asVar(_("Your browser does not support service workers, which are required to run this application. Please use a modern browser that supports service workers.")) ?>;
    return;
  }
  ...
  loadLibraries([
    ...
    document.getElementById('loading_message').innerHTML = bbn._("Libraries loaded successfully");
